var Greeter = /** @class */ (function () {
    function Greeter(element) {
        ...
        for (var _i = 0, recordsTable_1 = recordsTable; _i < recordsTable_1.length; _i++) {
            var iEntry = recordsTable_1[_i];
            var tr = document.createElement('tr');
            this.myTable.appendChild(tr);
            for (var _a = 0, iEntry_1 = iEntry; _a < iEntry_1.length; _a++) {
                var jEntry = iEntry_1[_a];
